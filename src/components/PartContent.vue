        ...
        <q-dialog v-model="seamless" seamless position="top">
          <q-card style="width: 350px">
            ...
            <q-card-section class="row items-center no-wrap">
              <div>
                <div class="text-weight-bold">Formilaire d'ajout Personne</div>
                <div class="text-grey">Ajouter une nouvelle personne</div>
              </div>
...
export default {
  components: { TablePart, FormPartenaire },
  setup() {
