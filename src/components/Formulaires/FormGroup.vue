  ...
  <q-layout view="hHh lpR fFf">
    ...
    <ul class="box-info q-pa-md">
      <li class="aos-item" data-aos="zoom-in-right">
        ...
        <span class="text">
          <h3>04</h3>
          <p>Categories Groupements Ajoutés</p>
        </span>
      </li>
      ...
      <q-card style="width: 350px">
        ...
        <q-card-section class="text-center q-pa-md">
          ...
          <q-form @submit="submitForm">
            <q-input
              dense
              v-model="nom_groupement"
              label="Groupement"
              type="text"
              required
            />
            <q-select
              v-model="id_collectivite"
              :options="id_collectivite"
              label="Selectionner la Collectivité"
              dense
              required
            />
          </q-form>
    ...
    <div class="q-pa-md">
      ...
      <q-table
        ...
        flat
        bordered
        title="Voici la liste des Collectivités"
        :columns="columns"
        :loading="loading"
        virtual-scroll
