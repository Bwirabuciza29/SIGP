  ...
  <q-layout view="hHh lpR fFf">
    ...
    <ul class="box-info q-pa-md">
      ...
      <li class="aos-item" data-aos="zoom-in">
        ...
        <span class="text">
          <h3>Quartier</h3>
          <p>Formulaire d'ajout Quartier</p>
        </span>
      </li>
    </ul>
    ...
    <q-dialog v-model="dialog" :position="position">
      <q-card style="width: 350px">
        ...
        <q-card-section class="text-center q-pa-md">
          <div class="text-weight-bold">Ajouter un Quartier</div>
          <q-form @submit="submitForm">
            <q-input
              dense
              v-model="nom_quartier"
              label="Quartier"
              type="text"
              required
            />
    ...
    <div class="q-pa-md">
      ...
      <q-table
        ...
        flat
        bordered
        title="Voici la liste des Quartiers"
        :columns="columns"
        :loading="loading"
        virtual-scroll
